    ...
    return (function() {
                    ...
                    var e = t((function(t, e) {
                        t.exports = function() {
                            ...
                            var y = function() {
                                ...
                                ,
                                l.$set = function(s, o) {
                                    var h, c = p.p(s), d = "set" + (this.$u ? "UTC" : ""), l = (h = {},
                                    h[i] = d + "Date",
                                    h[f] = d + "Date",
                                    h[a] = d + "Month",
                                    h[u] = d + "FullYear",
                                ...
                                l.diff = function(t, f, h) {
                                    var c, d = p.p(f), l = v(t), M = 6e4 * (l.utcOffset() - this.utcOffset()), $ = this - l, m = p.m(this, l);
                                    return m = (c = {},
                                    c[u] = m / 12,
                                    c[a] = m,
                                    c[o] = m / 3,
                            ...
                            [["$ms", t], ["$s", e], ["$m", n], ["$H", r], ["$W", i], ["$M", a], ["$y", u], ["$D", f]].forEach((function(t) {
                                g[t[1]] = function(e) {
                      ...
                      , n = t((function(t, e) {
                        ...
                        ,
                        i = /(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g,
                        u = {},
                        h = [/[+-]\d\d:?(\d\d)?/, function(t) {
        ...
        2: [function(require, module, exports) {
            ...
            class h {
                ...
                sort(t, e, s) {
                    ...
                    Promise.all(p).then((n => {
                        ...
                        c.classList.add("desc")) : (g = i(r, 1),
                        u = i(l, 1),
                        c.classList.remove("desc"),
                        c.classList.add("asc")),
                        a.lastTh && c != a.lastTh && (a.lastTh.classList.remove("desc"),
            ...
            const l = function(t) {
                ...
                t.data && t.data.length && (a = e("tbody"),
                t.data.forEach((s => {
                ...
                s && (null !== this.table.tHead && this.table.removeChild(this.table.tHead),
                this.table.appendChild(s)),
                a && (this.table.tBodies.length && this.table.removeChild(this.table.tBodies[0]),
            ...
            class o {
                ...
                render(t) {
                    ...
                    a += s.layout.top,
                    a += "</div>",
                    s.scrollY.length ? a += `<div class='dataTable-container' style='height: ${s.scrollY}; overflow-Y: auto;'></div>` : a += "<div class='dataTable-container'></div>",
                    a += "<div class='dataTable-bottom'>",
                    a += s.layout.bottom,
                    a += "</div>",
                    a = a.replace("{info}", s.paging ? "<div class='dataTable-info'></div>" : ""),
                    ...
                    this.data.forEach(( (e, s) => {
                        ...
                        t.split(" ").reduce(( (t, s) => {
                            ...
                            for (let t = 0; t < e.cells.length; t++)
                                if (i = e.cells[t],
                                n = i.hasAttribute("data-content") ? i.getAttribute("data-content") : i.textContent,
                                n.toLowerCase().includes(s) && this.columns(i.cellIndex).visible()) {
                                    a = !0;
                                    break
                                }
                            return t && a
                ...
                export(e) {
                    ...
                    if (o.type) {
                        if ("txt" !== o.type && "csv" !== o.type || (a[0] = this.header),
                        o.selection)
                ...
                import(e) {
                    ...
                    if (a.data.length || t(a.data)) {
                        if ("csv" === a.type) {
                            ...
                            t.length && (a.headings && (s.headings = t[0].split(a.columnDelimiter),
                            t.shift()),
                            t.forEach(( (t, e) => {
                                s.data[e] = [];
